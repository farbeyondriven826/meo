...
import BuildingPermitFormView from "@/Components/forms/requirements/building-forms/BuildingFormsView.vue";
...
function clickEditInformationHandler(){
    showEditInformationForm.value = true;
}
...
<template>
    <div class="w-full max-w-4xl mx-auto px-4 py-6 rounded-lg card mt-5">
        ...
        <Modal v-model:show="showPDFtemplate" :title="title">
            <template v-slot:content>
                <div class="flex justify-end m-4">
                    <button  class="bg-green-500 text-white text-sm px-4 py-2 rounded" @click="clickEditInformationHandler">Edit Information</button>
                </div>
                <div class="h-[70vh] overflow-auto">
                    <BuildingPermitFormView/>
                </div>
            </template>
            <template v-slot:footer>
                <div class="flex justify-end m-4">
                    <button @click="printPdf" class="mr-2 bg-blue-500 text-white text-sm px-4 py-2 rounded">Print</button>
                    <button @click="downloadPdf" class="bg-green-500 text-white text-sm px-4 py-2 rounded">Download</button>
                </div>
            </template>
        </Modal>
